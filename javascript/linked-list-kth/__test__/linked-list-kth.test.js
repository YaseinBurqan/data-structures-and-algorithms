...
test("returns the value of a given index from the end of linked list", () => {
  const ll = new LinkedList();
  ...
  expect(ll.kthEndIndex(3)).toEqual("c");
  // expect(ll.kthEndIndex(5)).toEqual("e");

  //expect(ll.kthEndIndex(-5)).toEqual("insert positive value ");
});
